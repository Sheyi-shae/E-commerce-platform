...
{/* navbar */}
<div className='w-screen lg:ml-[17.2%] md:w-full '>

<div className='w-[97vw] md:w-screen lg:w-[83%] rounded-xs fixed z-20  ml-1 bg-white shadow-sm  shadow-slate-300 dark:shadow-none dark:bg-slate-800 h-12  '>
...
<div></div>
{/* dynamic content */}
<div className= ' bg-slate-50  dark:bg-black ml-1 min-h-screen   md:w-full p-2 px-4 md:px-7 md:float-right mt-12  montserrat'>
{children}
    </div>
    </div>
