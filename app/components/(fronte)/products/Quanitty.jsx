...
useEffect(() => {
  ...
  return (
    ...
    <div className='flex  '>
    <span className='ring-slate-400 ring-1  shadow-sm overflow-hidden'>
      <button onClick={Decrement} className='hover:bg-slate-50 text-slate-800 font-medium px-4 p-2'>-</button>
    </span>


    <span className='ring-slate-400 ring-1 text-slate-600 font-semibold roboto-light px-8
...
<div className='mt-3'>
    <button type="button" className="text-white bg-gradient-to-br from-yellow-600 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200
     dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-9 py-4 text-center me-2 mb-2">ADD TO CART</button>
    </div>
    </div>
  )
}
