...
<TextInput
     ...
     Logging in ...</Button>
      : <Button gradientDuoTone="pinkToOrange" disabled={errorMessage} type="submit" className="px-10 md:px-12 montserrat"> 
      ...
      <div className="text-slate-700 w-full flex flex-col  ">
           ...
           {/* google button */}
              ...
              <button type="button" className="flex items-center shadow-md justify-center px-8 py-2 rounded-md bg-slate-200  hover:bg-slate-300">
  <span className="mr-2">
