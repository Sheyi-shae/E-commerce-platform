...
export function MainTab({description, productId ,reviews}) {
...
<Tabs defaultValue="description" className=" flex flex-col  justify-center items-center">
  ...
  <TabsContent value="customer review" className=' p-2 md:px-8  roboto-light text-xs md:text-sm'><ReviewTab reviews={reviews} productId={productId}/></TabsContent>
