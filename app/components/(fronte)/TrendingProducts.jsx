...
export default function TrendingProducts() {
  return (
    <div className='w-full md:max-h-[94vh] max-h-[203vh] overflow-hidden p-2 '>
      <div className='w-full shadow-sm dark:shadow-none h-[4vh] dark:bg-slate-700 md:h-[5vh] bg-slate-300 flex justify-between px-2 items-center'>
        <div>
          <h2 className='dark:text-slate-200 font-bold uppercase '>trending products</h2>
        </div>
